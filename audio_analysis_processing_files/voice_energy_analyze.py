...
def analyze_energy(
    ...
    """
    Analyze vocal energy characteristics:
    - average loudness
    - dynamic range
...
if __name__ == "__main__":
    y, sr = librosa.load(r"C:\Users\ALLAN\AppData\Local\Temp\myapp_uploads\temporary_audio.mp3")
    result = analyze_energy(y, sr)
    print(result)
